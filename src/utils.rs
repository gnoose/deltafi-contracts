...
/// Open Twap Flag
pub const TWAP_OPENED: u8 = 1;

/// Close Twap Falg
pub const TWAP_CLOSED: u8 = 0;

/// curve mode - pmm
pub const CURVE_PMM: u8 = 0;
...
pub mod test_utils {
    ...
    impl SwapAccountInfo {
        pub fn new(
            ...
            let pyth_key = pubkey_rand();
            let pyth_account = Account::new(0, SplAccount::get_packed_len(), &SWAP_PROGRAM_ID);
